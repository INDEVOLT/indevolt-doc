---
title: 第三方逆变器双计量方案
description: 通过增加光伏计量设备，使系统同时获取光伏发电与用电数据，从而实现更完整的能源监测与储能控制
---
...
当家庭已经安装第三方光伏逆变器时，系统通常通过 **负载电表** 来检测家庭与电网之间的电力流动，并控制储能设备运行：
...
在现有负载电表的基础上，新增一台**光伏计量设备**，安装完成后：

- 负载电表负责监测家庭与电网之间的电力交换
- 光伏计量设备负责监测光伏逆变器的发电数据
